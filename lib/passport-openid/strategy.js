...
Strategy.prototype._parseProfileExt = function(params) {
  ...
  if (!profile.displayName) {
    if (params['http://axschema.org/namePerson/first'] && params['http://axschema.org/namePerson/last']) {
      profile.displayName = params['http://axschema.org/namePerson/first'] + ' ' + params['http://axschema.org/namePerson/last'];
    }
  }
  if (!profile.emails) {
    profile.emails = [{ value: params['email'] }];
  }
  profile.realmId = params['http://axschema.org/intuit/realmId'];
